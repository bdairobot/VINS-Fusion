...
struct VIOFactorAuto
{
	...
	template <typename T>
	bool operator()(const T* const q_w_i, const T* p_i_xy, const T* p_i_z, const T* q_w_j, const T* p_j_xy, const T* p_j_z, const T* const q_w_v, const T* const p_w_v, const T* scale, , T* residuals) const
	{
		T t_w_ij[3];
									   ...
									   const double p_dev, const double q_dev) 
	{
	  return (new ceres::AutoDiffCostFunction<
	          VIOFactorAuto, 9, 4, 2, 1, 4, 2, 1, 4, 3, 1>(
